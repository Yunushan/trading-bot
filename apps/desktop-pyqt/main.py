"""
Canonical desktop product launcher.

This wrapper exposes the repository-level desktop app boundary under ``apps/``
...
CANONICAL_PRODUCT_MODULE = "app.desktop.product_main"
