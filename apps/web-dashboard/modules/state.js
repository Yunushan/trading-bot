...
export const elements = {
  ...
  preflightStart: document.getElementById("preflight-start"),
  preflightOrders: document.getElementById("preflight-orders"),
  preflightMode: document.getElementById("preflight-mode"),
  preflightCritical: document.getElementById("preflight-critical"),
  preflightAges: document.getElementById("preflight-ages"),
  ...
  llmExecution: document.getElementById("llm-execution"),
  llmCatalog: document.getElementById("llm-catalog"),
  llmMessage: document.getElementById("llm-message"),
  connectorHealth: document.getElementById("connector-health"),
  connectorState: document.getElementById("connector-state"),
  connectorBackend: document.getElementById("connector-backend"),
  connectorSupport: document.getElementById("connector-support"),
  connectorRateLimit: document.getElementById("connector-rate-limit"),
  connectorNetwork: document.getElementById("connector-network"),
  connectorOrderCircuit: document.getElementById("connector-order-circuit"),
  connectorIncidentLog: document.getElementById("connector-incident-log"),
  connectorLastIncident: document.getElementById("connector-last-incident"),
  connectorUpdated: document.getElementById("connector-updated"),
  connectorLastError: document.getElementById("connector-last-error"),
  resetConnectorCircuitButton: document.getElementById("reset-connector-circuit-button"),
  connectorMessage: document.getElementById("connector-message"),
  connectorIncidentsCount: document.getElementById("connector-incidents-count"),
  connectorIncidentsEmpty: document.getElementById("connector-incidents-empty"),
  connectorIncidentsList: document.getElementById("connector-incidents-list"),
  ...
  configOrderAuditBackupCount: document.getElementById("config-order-audit-backup-count"),
  configIncidentLogMaxBytes: document.getElementById("config-incident-log-max-bytes"),
  ...
  configExecutionHeartbeatStaleSeconds: document.getElementById("config-execution-heartbeat-stale-seconds"),
  configAccountStaleSeconds: document.getElementById("config-account-stale-seconds"),
  ...
  configLiveAutoBumpEnabled: document.getElementById("config-live-auto-bump-enabled"),
