...
import {
  ...
  SERVICE_API_VERSION,
  serviceApiRoute,
} from "../modules/service-contract.js";
...
await test("dashboard required route names resolve to versioned API paths", async () => {
  for (const routeName of DASHBOARD_REQUIRED_ROUTE_NAMES) {
    assert.equal(
