...
| `tools/build_exe.ps1` | Windows PyInstaller build script for `Trading-Bot-Python.exe` |
| `tools/build_binary.sh` | Unix shell build wrapper for standalone Python binary packaging |
