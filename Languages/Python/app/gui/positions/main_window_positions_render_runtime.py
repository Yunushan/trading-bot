...
from . import main_window_positions_table_render_runtime
...
def configure_main_window_positions_render_runtime(
    *,
    ...
    main_window_positions_table_render_runtime.configure_main_window_positions_render_runtime(
...
def _mw_render_positions_table(self):
    return main_window_positions_table_render_runtime._mw_render_positions_table(self)
