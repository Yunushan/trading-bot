...
from . import history_records_runtime, history_update_runtime
...
def configure_main_window_positions_history_runtime(
    *,
    ...
    history_records_runtime.configure_main_window_positions_history_records_runtime(
    ...
    history_update_runtime.configure_main_window_positions_history_update_runtime(
        closed_history_max_fn=closed_history_max_fn,
        resolve_trigger_indicators=resolve_trigger_indicators,
    )
...
def _mw_positions_records_per_trade(self, open_records: dict, closed_records: list) -> list:
    return history_records_runtime._mw_positions_records_per_trade(
        self,
        open_records,
        closed_records,
    )
...
def _mw_update_position_history(self, positions_map: dict):
    return history_update_runtime._mw_update_position_history(
        self,
        positions_map,
    )
