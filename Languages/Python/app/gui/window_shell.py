...
from app.gui.runtime.composition import bindings_runtime, module_state_runtime  # noqa: E402
from app.gui.runtime.ui import theme_styles  # noqa: E402
from app.gui.runtime.window import init_ui_runtime, startup_runtime  # noqa: E402


module_state_runtime.install_main_window_module_state(
    globals(),
    this_file=_THIS_FILE,
)
_apply_window_icon = globals()["_apply_window_icon"]
...
class MainWindow(QtWidgets.QWidget):
    ...
    def _on_trade_signal(self, order_info: dict):
        ...
        return trade_runtime._mw_on_trade_signal(self, order_info)

    LIGHT_THEME = theme_styles.LIGHT_THEME
    DARK_THEME = theme_styles.DARK_THEME
    ...
    def __init__(self):
        ...
        try:
            ...
            pass
        startup_runtime.apply_standard_window_flags(self)
    ...
    def init_ui(self):
        ...
        MAX_CLOSED_HISTORY = init_ui_runtime.build_main_window_tabs_ui(
            self,
            current_max_closed_history=MAX_CLOSED_HISTORY,
        )


bindings_runtime.bind_main_window_class(
    MainWindow,
