...
def _load_binding_modules() -> SimpleNamespace:
    ...
    from app.gui.code import main_window_code, main_window_code_runtime
    ...
    from app.gui.positions import main_window_positions, main_window_positions_tab
    ...
    from app.gui.shared import main_window_config
    ...
    return SimpleNamespace(
        ...
        runtime=SimpleNamespace(
            ...
            strategy=SimpleNamespace(
                main_window_control_runtime=main_window_control_runtime,
                main_window_indicator_runtime=main_window_indicator_runtime,
                main_window_override_runtime=main_window_override_runtime,
                main_window_stop_loss_runtime=main_window_stop_loss_runtime,
                main_window_strategy_context_runtime=main_window_strategy_context_runtime,
                main_window_strategy_controls_runtime=main_window_strategy_controls_runtime,
                main_window_strategy_ui_runtime=main_window_strategy_ui_runtime,
            ),
            ui=SimpleNamespace(
