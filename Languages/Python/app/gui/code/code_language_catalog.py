...
STARTER_CRYPTO_EXCHANGES = [
    {"key": "Binance", "title": "Binance", "subtitle": "Advanced desktop bot ready to launch", "accent": "#fbbf24"},
    {
        "key": "Bybit",
        "title": "Bybit",
        "subtitle": "ccxt order routing; live evidence required",
        "accent": "#fb7185",
...
STARTER_FOREX_BROKERS = [
    {
        "key": "OANDA",
        "title": "OANDA",
        "subtitle": "REST-v20 order routing; live evidence required",
        "accent": "#60a5fa",
        "badge": "order routing",
    },
    {
        "key": "FXCM",
        "title": "FXCM",
        "subtitle": "fxcmpy order routing; live evidence required",
        "accent": "#c084fc",
        "badge": "order routing",
    },
    {
        "key": "IG",
        "title": "IG",
        "subtitle": "REST order routing; live evidence required",
        "accent": "#f472b6",
        "badge": "order routing",
    },
]
