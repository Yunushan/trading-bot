...
def launch_cpp_from_code_tab(
    ...
    *,
    ...
    try:
        ...
        early_exit = poll_early_exit(process, timeout_s=0.45)
            ...
            if sys.platform == "win32":
                ...
                if not redeploy_ok:
                    ...
                    try:
                        ...
                        retry_exit = poll_early_exit(retry_process, timeout_s=0.45)
            ...
            if not retry_succeeded and not is_frozen_python_app():
                ...
                if rebuilt_exe is not None and rebuilt_exe.is_file():
                    ...
                    try:
                        ...
                        rebuild_exit = poll_early_exit(rebuild_process, timeout_s=0.45)
...
__all__ = ["launch_cpp_from_code_tab"]
