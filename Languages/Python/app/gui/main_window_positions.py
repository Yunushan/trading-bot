...
from . import (
    indicator_value_helpers,
    main_window_positions_actions_runtime,
    main_window_positions_build_runtime,
    main_window_positions_history_runtime,
    main_window_positions_render_runtime,
...
def _copy_allocations_for_key(alloc_map_global: dict, symbol: str, side_key: str) -> list[dict]:
    return main_window_positions_build_runtime._copy_allocations_for_key(
        alloc_map_global,
        symbol,
        side_key,
    )
...
def _seed_positions_map_from_rows(self, base_rows: list, alloc_map_global: dict, prev_records: dict) -> dict[tuple, dict]:
    return main_window_positions_build_runtime._seed_positions_map_from_rows(
        self,
        base_rows,
        alloc_map_global,
        prev_records,
...
def _apply_interval_metadata_to_row(
    ...
    *,
    ...
    return main_window_positions_build_runtime._apply_interval_metadata_to_row(
        self,
        sym=sym,
        side_key=side_key,
        rec=rec,
...
def _merge_futures_rows_into_positions_map(self, base_rows: list, positions_map: dict, alloc_map_global: dict) -> None:
    return main_window_positions_build_runtime._merge_futures_rows_into_positions_map(
        self,
        base_rows,
        positions_map,
        alloc_map_global,
...
def _mw_render_positions_table(self):
    return main_window_positions_render_runtime._mw_render_positions_table(self)




def _gui_on_positions_ready(self, rows: list, acct: str):
    return main_window_positions_build_runtime._gui_on_positions_ready(self, rows, acct)

def _mw_positions_records_per_trade(self, open_records: dict, closed_records: list) -> list:
    return main_window_positions_history_runtime._mw_positions_records_per_trade(
        self,
        open_records,
        closed_records,
    )
...
def _mw_update_position_history(self, positions_map: dict):
    return main_window_positions_history_runtime._mw_update_position_history(
        self,
        positions_map,
    )
...
def bind_main_window_positions(
    ...
    *,
    ...
    main_window_positions_build_runtime.configure_main_window_positions_build_runtime(
        resolve_trigger_indicators=resolve_trigger_indicators,
    )
    main_window_positions_history_runtime.configure_main_window_positions_history_runtime(
    ...
    main_window_positions_render_runtime.configure_main_window_positions_render_runtime(
        closed_record_states=_CLOSED_RECORD_STATES,
    ...
    main_window_positions_actions_runtime.bind_main_window_positions_actions_runtime(
        main_window_cls,
        save_position_allocations=save_position_allocations,
        closed_history_max_fn=_closed_history_max,
        pos_status_column=pos_status_column,
    )
    main_window_positions_tracking_runtime.bind_main_window_positions_tracking_runtime(
        main_window_cls,
        resolve_trigger_indicators=resolve_trigger_indicators,
        closed_history_max_fn=_closed_history_max,
