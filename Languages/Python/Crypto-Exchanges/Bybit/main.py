...
def _install_cbt_startup_window_suppression() -> None:
    ...
    debug_log_path = Path(os.getenv("TEMP") or ".").resolve() / "bybit_window_events.log"
...
APP_USER_MODEL_ID = "Bybit.TradingBot"
...
def main() -> int:
    ...
    app.setApplicationDisplayName("Bybit Trading Bot")
    ...
    if sys.platform == "win32" and not disable_taskbar:
        ...
        def _apply_taskbar(attempts: int = 12) -> None:
            ...
            success = apply_taskbar_metadata(
                ...
                display_name="Bybit Trading Bot",
                icon_path=icon_path,
