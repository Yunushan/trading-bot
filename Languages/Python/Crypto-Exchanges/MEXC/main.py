...
def _install_cbt_startup_window_suppression() -> None:
    ...
    debug_log_path = Path(os.getenv("TEMP") or ".").resolve() / "mexc_window_events.log"
...
APP_USER_MODEL_ID = "MEXC.TradingBot"
...
def main() -> int:
    ...
    app.setApplicationName("MEXC Trading Bot")
    app.setApplicationDisplayName("MEXC Trading Bot")
