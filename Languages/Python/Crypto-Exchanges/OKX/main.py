...
def _install_cbt_startup_window_suppression() -> None:
    ...
    debug_log_path = Path(os.getenv("TEMP") or ".").resolve() / "okx_window_events.log"
...
APP_USER_MODEL_ID = "OKX.TradingBot"
...
def main() -> int:
    ...
    app.setApplicationName("OKX Trading Bot")
