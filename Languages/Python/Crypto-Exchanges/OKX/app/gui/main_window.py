...
APP_STATE_PATH = Path.home() / ".okx_trading_bot_state.json"
...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self._chart_debug_log_path = Path(os.getenv("TEMP") or ".").resolve() / "okx_chart_debug.log"
    ...
    def _chart_debug_log(self, message: str) -> None:
        ...
        try:
            ...
            if path is None:
                path = Path(os.getenv("TEMP") or ".").resolve() / "okx_chart_debug.log"
    ...
    def init_ui(self):
        self.setWindowTitle("OKX Trading Bot")
        try:
