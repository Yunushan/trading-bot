...
from app.bootstrap import startup_ui
...
def _configure_startup_window_suppression_defaults() -> None:
    ...
    if not _env_flag("BOT_FORCE_STARTUP_WINDOW_HOOKS"):
        ...
        # WinEvent/poll suppression bundle. Avoid the full-screen startup mask
        # by default because it can obscure other apps on Windows while the UI
...
def main() -> int:
    ...
    def _show_main_window(*, activate: bool) -> None:
        nonlocal startup_main_window_shown
