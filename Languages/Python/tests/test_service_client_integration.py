...
'''
    ...
    def test_service_terminal_and_llm_config_commands(self):
        ...
        self.assertIn("kilo", provider_by_key)
        ...
        self.assertIn("gpt-5.6-sol", provider_by_key["openai"]["model_suggestions"])
        self.assertIn("gpt-5.6-terra", provider_by_key["openai"]["model_suggestions"])
        self.assertIn("gpt-5.6-luna", provider_by_key["openai"]["model_suggestions"])
        self.assertIn("max", provider_by_key["openai"]["reasoning_efforts"])
        self.assertEqual("https://api.kilo.ai/api/gateway", provider_by_key["kilo"]["default_base_url"])
        self.assertEqual("kilo-auto/frontier", provider_by_key["kilo"]["default_model"])
        self.assertIn("openai-chat-completions", provider_by_key["kilo"]["api_styles"])
        self.assertIn("openai-responses", provider_by_key["kilo"]["api_styles"])
        self.assertTrue(provider_by_key["kilo"]["supports_model_discovery"])
        self.assertEqual("models", provider_by_key["kilo"]["model_discovery_path"])
        self.assertIn("gpt-4", provider_by_key["openai"]["model_suggestions"])
        self.assertIn("gpt-3.5-turbo", provider_by_key["openai"]["model_suggestions"])
        ...
        self.assertIn("qwen3.7-max", provider_by_key["qwen"]["model_suggestions"])
        self.assertIn("max", provider_by_key["qwen"]["reasoning_efforts"])
        self.assertEqual("https://api.moonshot.ai/v1", provider_by_key["moonshot"]["default_base_url"])
        self.assertEqual("kimi-k3", provider_by_key["moonshot"]["default_model"])
        self.assertIn("kimi-k2.5", provider_by_key["moonshot"]["model_suggestions"])
        self.assertIn("max", provider_by_key["moonshot"]["reasoning_efforts"])
        ...
        self.assertIn("api_style", service.get_llm_config_payload())
        self.assertIn("speed", service.get_llm_config_payload())
        self.assertIn("context_window", service.get_llm_config_payload())
        self.assertIn("max_output_tokens", service.get_llm_config_payload())
        self.assertIn("request_options", service.get_llm_config_payload())
