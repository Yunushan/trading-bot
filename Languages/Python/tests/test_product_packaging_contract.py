...
class ProductPackagingContractTests(unittest.TestCase):
    ...
    def test_release_platform_real_test_matrix_covers_requested_targets(self):
        ...
        self.assertIn("Verify selected self-hosted runners are available", real_test_workflow)
        self.assertIn("tools/check_release_runner_availability.py", real_test_workflow)
        self.assertIn("RELEASE_RUNNER_STATUS_TOKEN", real_test_workflow)
