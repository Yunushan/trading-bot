...
class TradingCoreContractTests(unittest.TestCase):
    ...
    def test_domain_modules_reexport_stable_public_contracts(self):
        ...
        self.assertIs(trading_indicators.aroon, app_indicators.aroon)
        self.assertIs(trading_indicators.awesome_oscillator, app_indicators.awesome_oscillator)
        self.assertIs(trading_indicators.bollinger_band_width, app_indicators.bollinger_band_width)
        self.assertIs(trading_indicators.chaikin_money_flow, app_indicators.chaikin_money_flow)
        self.assertIs(trading_indicators.cci, app_indicators.cci)
        self.assertIs(trading_indicators.choppiness_index, app_indicators.choppiness_index)
        self.assertIs(trading_indicators.ichimoku_cloud, app_indicators.ichimoku_cloud)
        self.assertIs(trading_indicators.keltner_channels, app_indicators.keltner_channels)
        self.assertIs(trading_indicators.kst, app_indicators.kst)
        self.assertIs(trading_indicators.mfi, app_indicators.mfi)
        self.assertIs(trading_indicators.natr, app_indicators.natr)
        self.assertIs(trading_indicators.obv, app_indicators.obv)
        self.assertIs(trading_indicators.ppo, app_indicators.ppo)
        self.assertIs(trading_indicators.relative_volume, app_indicators.relative_volume)
        self.assertIs(trading_indicators.roc, app_indicators.roc)
        self.assertIs(trading_indicators.rsi, app_indicators.rsi)
        self.assertIs(trading_indicators.trix, app_indicators.trix)
        self.assertIs(trading_indicators.supertrend, app_indicators.supertrend)
        self.assertIs(trading_indicators.vwap, app_indicators.vwap)
