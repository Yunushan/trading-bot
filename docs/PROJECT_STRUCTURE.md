...
- `Languages/Python/app/gui/runtime/composition/main_window_bindings_runtime.py` is now the extracted `main_window.py` class-binding/configuration slice
- `Languages/Python/app/gui/runtime/composition/main_window_module_state_runtime.py` is now the extracted `main_window.py` constant/helper-alias module-state slice
...
- `Languages/Python/app/gui/runtime/strategy/main_window_start_strategy_runtime.py` now carries the extracted start-engine lifecycle and loop-build helpers, with `strategy/main_window_control_runtime.py` keeping the control-surface wrappers
- `Languages/Python/app/gui/runtime/strategy/main_window_stop_strategy_runtime.py` now carries the extracted stop-engine and close-all lifecycle helpers, with `strategy/main_window_control_runtime.py` keeping the control-surface wrappers
