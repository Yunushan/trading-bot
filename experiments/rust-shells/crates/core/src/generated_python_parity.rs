...
mod generated {
    ...
    pub const PYTHON_OPERATIONAL_MAX_FUTURE_SKEW_MS: i64 = 5000;
    pub const PYTHON_OPERATIONAL_FRESHNESS_REFERENCE_JSON: &str = "[{\"allowed\":true,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"fresh\",\"now_ms\":1780000000000,\"reported_age_ms\":1000,\"timestamp_ms\":1779999999000},{\"allowed\":true,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"age-boundary\",\"now_ms\":1780000000000,\"reported_age_ms\":300000,\"timestamp_ms\":1779999700000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"expired\",\"now_ms\":1780000000000,\"reported_age_ms\":300001,\"timestamp_ms\":1779999699999},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"missing\",\"now_ms\":1780000000000,\"reported_age_ms\":null,\"timestamp_ms\":null},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"negative-timestamp\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":-1},{\"allowed\":true,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"skew-boundary\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000005000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"future\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000005001},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":0,\"name\":\"zero-limit\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":-1,\"name\":\"negative-limit\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"negative-clock\",\"now_ms\":-1,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"cached-expired\",\"now_ms\":1780000300001,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1779999699999,\"max_age_ms\":300000,\"name\":\"envelope-expired\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000005001,\"max_age_ms\":300000,\"name\":\"envelope-future\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":-1,\"max_age_ms\":300000,\"name\":\"envelope-negative\",\"now_ms\":1780000000000,\"reported_age_ms\":0,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"reported-age-expired\",\"now_ms\":1780000000000,\"reported_age_ms\":300001,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"reported-age-negative\",\"now_ms\":1780000000000,\"reported_age_ms\":-1,\"timestamp_ms\":1780000000000},{\"allowed\":false,\"generated_at_ms\":1780000000000,\"max_age_ms\":300000,\"name\":\"reported-age-missing\",\"now_ms\":1780000000000,\"reported_age_ms\":null,\"timestamp_ms\":1780000000000}]";
...
pub const PYTHON_RUNTIME_CONFIG_REFERENCE_CASES: &[PythonRuntimeConfigReferenceCase] = &[
    ...
    PythonRuntimeConfigReferenceCase {
        ...
        input_json: "{\"chart\":{\"auto_follow\":true,\"interval\":\"15m\",\"market\":\"Spot\",\"symbol\":\"BTCUSDT\",\"view_mode\":\"lightweight\"},\"intervals\":[\"15m\"],\"loop_interval_override\":\"5m\",\"mode\":\"Demo/Testnet\",\"order_type\":\"MARKET\",\"position_pct\":1.5,\"side\":\"BUY\",\"symbols\":[\"BTCUSDT\"],\"tif\":\"GTC\"}",
        expected_json: "{\"chart\":{\"auto_follow\":true,\"interval\":\"15m\",\"market\":\"Spot\",\"symbol\":\"BTCUSDT\",\"view_mode\":\"lightweight\"},\"intervals\":[\"15m\"],\"loop_interval_override\":\"5m\",\"mode\":\"Demo/Testnet\",\"order_type\":\"MARKET\",\"position_pct\":1.5,\"side\":\"BUY\",\"symbols\":[\"BTCUSDT\"],\"tif\":\"GTC\"}",
        valid: true,
        expected_error: "",
    },
    PythonRuntimeConfigReferenceCase {
    ...
    PythonRuntimeConfigReferenceCase {
        ...
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: mode: must be a non-empty text value; mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)",
    },
    PythonRuntimeConfigReferenceCase {
        name: "invalid-mode-paper",
        input_json: "{\"mode\":\"Paper\"}",
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)",
    },
    PythonRuntimeConfigReferenceCase {
        name: "invalid-mode-paper-local",
        input_json: "{\"mode\":\"Paper Local\"}",
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)",
    },
    PythonRuntimeConfigReferenceCase {
        name: "invalid-mode-embedded-test",
        input_json: "{\"mode\":\"contest\"}",
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)",
    },
    PythonRuntimeConfigReferenceCase {
        name: "invalid-mode-embedded-demo",
        input_json: "{\"mode\":\"my-demo-mode\"}",
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)",
    },
    ...
    PythonRuntimeConfigReferenceCase {
        ...
        expected_json: "{}",
        valid: false,
        expected_error: "Invalid config: llm_provider: must be one of: anthropic, deepseek, gemini, grok, kilo, llamacpp, lmstudio, local, mistral, moonshot, ollama, open-source, openai, qwen, tgi, vllm",
    },
    PythonRuntimeConfigReferenceCase {
    ...
    PythonRuntimeConfigReferenceCase {
        name: "choice-llm_provider-kilo",
        input_json: "{\"llm_provider\":\"kilo\"}",
        expected_json: "{\"llm_provider\":\"kilo\"}",
        valid: true,
        expected_error: "",
    },
    PythonRuntimeConfigReferenceCase {
        name: "choice-llm_provider-kilo-ai",
        input_json: "{\"llm_provider\":\"kilo-ai\"}",
        expected_json: "{\"llm_provider\":\"kilo\"}",
        valid: true,
        expected_error: "",
    },
    PythonRuntimeConfigReferenceCase {
        name: "choice-llm_provider-kilo-code",
        input_json: "{\"llm_provider\":\"kilo-code\"}",
        expected_json: "{\"llm_provider\":\"kilo\"}",
        valid: true,
        expected_error: "",
    },
    ...
    PythonRuntimeConfigReferenceCase {
        name: "choice-llm_provider-kilocode",
        input_json: "{\"llm_provider\":\"kilocode\"}",
        expected_json: "{\"llm_provider\":\"kilo\"}",
        valid: true,
        expected_error: "",
    },
...
pub const PYTHON_NATIVE_RUNTIME_MODE_REFERENCE_CASES: &[PythonNativeRuntimeModeReferenceCase] = &[
    ...
    pub const PYTHON_SOURCE_CONTRACT_HASH: &str = "f924ff5fcf7a141fdc863059a7f865d9a2d8140821272f4b29f8d3a7e63f61dc";
    ...
    pub const PYTHON_NATIVE_RUNTIME_LIVE_MODE_VALUES: &[&str] = &[
    "live",
    "live trading",
    "production",
];
    pub const PYTHON_INVALID_EXECUTION_MODE_ERROR: &str = "unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)";
...
pub const PYTHON_SERVICE_ROUTE_SCHEMAS: &[PythonServiceRouteSchema] = &[
    ...
    PythonServiceRouteSchema {
        ...
        query_fields: &[],
        request_fields: &[],
        response_fields: &["session_id", "state", "workload_kind", "status_message", "symbols", "intervals", "indicator_keys", "logic", "symbol_source", "capital", "execution_model", "run_count", "error_count", "cancelled", "started_at", "completed_at", "updated_at", "source", "top_run", "runs", "top_runs", "errors"],
    },
    PythonServiceRouteSchema {
        name: "config_summary",
        query_fields: &[],
    ...
    PythonServiceRouteSchema {
        name: "portfolio",
        query_fields: &[],
        request_fields: &["open_position_records", "closed_position_records", "closed_trade_registry", "active_pnl", "active_margin", "closed_pnl", "closed_margin", "total_balance", "available_balance", "observed_at", "source"],
    ...
    PythonServiceRouteSchema {
        ...
        query_fields: &[],
        request_fields: &[],
        response_fields: &["ok", "provider", "catalog_revision", "dynamic_count", "models", "error"],
    },
    PythonServiceRouteSchema {
        name: "llm_prompt",
        query_fields: &[],
...
pub const PYTHON_INDICATOR_CATALOG: &[PythonIndicator] = &[
    ...
    pub const PYTHON_LLM_PROVIDER_CATALOG_REVISION: &str = "2026-08-26";
...
pub const PYTHON_LLM_PROVIDERS: &[PythonLlmProvider] = &[
    PythonLlmProvider {
        ...
        notes: &["Supports the OpenAI Responses and Chat Completions APIs; choose the API style per model.", "GPT-5.6 Sol, Terra, and Luna support reasoning levels through max; availability depends on the API account.", "Historical model IDs remain selectable, but retired upstream models may no longer accept requests."],
    },
    PythonLlmProvider {
        key: "kilo",
        ...
        custom_models_path_env: "BOT_LLM_MODEL_CATALOG_PATH",
        notes: &["Uses Kilo's OpenAI-compatible gateway and provider/model identifiers.", "Refresh model discovery to merge every model currently returned by Kilo with historical and custom IDs.", "Kilo auto model IDs remain stable while their routed backing models can change server-side."],
    },
    PythonLlmProvider {
        key: "anthropic",
        ...
        model_suggestions: &["claude-sonnet-4-5-20250929", "claude-haiku-4-5-20251001", "claude-opus-4-5-20251101", "claude-opus-4-1-20250805", "claude-opus-4-20250514", "claude-sonnet-4-20250514", "claude-sonnet-4-5", "claude-haiku-4-5", "claude-opus-4-5", "claude-opus-4-1", "claude-opus-4-0", "claude-sonnet-4-0", "claude-3-7-sonnet-20250219", "claude-3-5-sonnet-20241022", "claude-3-5-sonnet-20240620", "claude-3-5-haiku-20241022", "claude-3-opus-20240229", "claude-3-sonnet-20240229", "claude-3-haiku-20240307"],
        reasoning_efforts: &["default", "disabled", "enabled", "low", "medium", "high"],
        default_reasoning_effort: "default",
        api_styles: &["anthropic-messages"],
        speed_options: &["default", "auto", "fast", "balanced", "quality", "flex", "priority"],
        default_speed: "default",
        supports_model_discovery: true,
        model_discovery_path: "models",
    ...
    PythonLlmProvider {
        ...
        model_suggestions: &["gemini-3.1-pro-preview", "gemini-3.1-pro-preview-customtools", "gemini-3-flash-preview", "gemini-3.1-flash-lite-preview", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-preview-09-2025", "gemini-2.5-flash-lite", "gemini-2.5-flash-lite-preview-09-2025", "gemini-2.0-flash", "gemini-2.0-flash-lite", "gemini-1.5-pro", "gemini-1.5-flash"],
        reasoning_efforts: &["default", "minimal", "low", "medium", "high"],
        default_reasoning_effort: "default",
        api_styles: &["gemini-generate-content"],
        speed_options: &["default", "auto", "fast", "balanced", "quality", "flex", "priority"],
        default_speed: "default",
        supports_model_discovery: true,
        model_discovery_path: "models",
    ...
    PythonLlmProvider {
        ...
        default_reasoning_effort: "default",
        api_styles: &["openai-chat-completions"],
        speed_options: &["default", "auto", "fast", "balanced", "quality", "flex", "priority"],
        default_speed: "default",
        supports_model_discovery: true,
        model_discovery_path: "models",
    ...
    PythonLlmProvider {
        ...
        reasoning_efforts: &["default", "none", "disabled", "minimal", "auto", "low", "medium", "high", "xhigh", "max"],
        default_reasoning_effort: "default",
        api_styles: &["openai-chat-completions", "openai-responses"],
        speed_options: &["default", "auto", "fast", "balanced", "quality", "flex", "priority"],
        default_speed: "default",
...
pub const PYTHON_TRADINGVIEW_INTERVAL_MAP: &[PythonTradingViewInterval] = &[
    ...
    pub const PYTHON_OPTION_CATALOG_COUNT: usize = 48;
pub const PYTHON_OPTION_CATALOG_ENTRY_COUNT: usize = 279;
pub const PYTHON_UI_OPTION_CATALOG_COUNT: usize = 32;
pub const PYTHON_UI_OPTION_ENTRY_COUNT: usize = 122;
...
pub const PYTHON_OPTION_CATALOG_MANIFEST: &[PythonOptionCatalogManifestEntry] = &[
    ...
    PythonOptionCatalogManifestEntry { name: "llm_api_style_options", entry_count: 5 },
    PythonOptionCatalogManifestEntry { name: "llm_speed_options", entry_count: 7 },
...
pub const PYTHON_LLM_API_STYLE_OPTIONS: &[PythonUiOption] = &[
    PythonUiOption {
...
pub const PYTHON_LLM_SPEED_OPTIONS: &[PythonUiOption] = &[
    PythonUiOption {
        key: "default",
        label: "default",
        disabled: false,
...
pub const PYTHON_UI_OPTION_CATALOGS: &[PythonUiOptionCatalog] = &[
    ...
    PythonUiOptionCatalog { name: "LLM API style", options: PYTHON_LLM_API_STYLE_OPTIONS },
    PythonUiOptionCatalog { name: "LLM speed", options: PYTHON_LLM_SPEED_OPTIONS },
