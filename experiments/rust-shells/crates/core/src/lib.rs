            ...
            sections: &[
                TradingAppSection {
                    ...
                    items: &[
                        ...
                        "Connector: Binance SDK Derivatives Trading USD-S Futures, Binance SDK Derivatives Trading COIN-M Futures, Binance SDK Spot, Binance Connector Python, CCXT, OANDA REST-v20, FXCM fxcmpy, IG REST Trading API, python-binance",
