            ...
            sections: &[
                ...
                TradingAppSection {
                    ...
                    items: &[
                        ...
                        "OKX (ccxt diagnostics)",
                        "Gate (ccxt diagnostics)",
                        "Bitget (ccxt diagnostics)",
                        "MEXC (ccxt diagnostics)",
                        "KuCoin (ccxt diagnostics)",
                        "HTX (ccxt diagnostics)",
                        "Crypto.com Exchange (ccxt diagnostics)",
                        "Kraken (ccxt diagnostics)",
                        "Bitfinex (ccxt diagnostics)",
                    ],
                },
                TradingAppSection {
