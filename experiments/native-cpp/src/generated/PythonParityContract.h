...
inline constexpr std::string_view kPythonSourceContractHash = "f924ff5fcf7a141fdc863059a7f865d9a2d8140821272f4b29f8d3a7e63f61dc";
...
inline constexpr std::array<PythonRuntimeConfigReferenceCase, 224> kPythonRuntimeConfigReferenceCases = {
    ...
    PythonRuntimeConfigReferenceCase{"canonical-runtime", "{\"chart\":{\"auto_follow\":true,\"interval\":\"15m\",\"market\":\"Spot\",\"symbol\":\"BTCUSDT\",\"view_mode\":\"lightweight\"},\"intervals\":[\"15m\"],\"loop_interval_override\":\"5m\",\"mode\":\"Demo/Testnet\",\"order_type\":\"MARKET\",\"position_pct\":1.5,\"side\":\"BUY\",\"symbols\":[\"BTCUSDT\"],\"tif\":\"GTC\"}", "{\"chart\":{\"auto_follow\":true,\"interval\":\"15m\",\"market\":\"Spot\",\"symbol\":\"BTCUSDT\",\"view_mode\":\"lightweight\"},\"intervals\":[\"15m\"],\"loop_interval_override\":\"5m\",\"mode\":\"Demo/Testnet\",\"order_type\":\"MARKET\",\"position_pct\":1.5,\"side\":\"BUY\",\"symbols\":[\"BTCUSDT\"],\"tif\":\"GTC\"}", true, ""},
    ...
    PythonRuntimeConfigReferenceCase{"invalid-mode-empty", "{\"mode\":\"\"}", "{}", false, "Invalid config: mode: must be a non-empty text value; mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    PythonRuntimeConfigReferenceCase{"invalid-mode-paper", "{\"mode\":\"Paper\"}", "{}", false, "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    PythonRuntimeConfigReferenceCase{"invalid-mode-paper-local", "{\"mode\":\"Paper Local\"}", "{}", false, "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    PythonRuntimeConfigReferenceCase{"invalid-mode-embedded-test", "{\"mode\":\"contest\"}", "{}", false, "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    PythonRuntimeConfigReferenceCase{"invalid-mode-embedded-demo", "{\"mode\":\"my-demo-mode\"}", "{}", false, "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    PythonRuntimeConfigReferenceCase{"invalid-mode-unknown", "{\"mode\":\"unknown\"}", "{}", false, "Invalid config: mode: unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)"},
    ...
    PythonRuntimeConfigReferenceCase{"invalid-llm-provider", "{\"llm_provider\":\"ghost-ai\"}", "{}", false, "Invalid config: llm_provider: must be one of: anthropic, deepseek, gemini, grok, kilo, llamacpp, lmstudio, local, mistral, moonshot, ollama, open-source, openai, qwen, tgi, vllm"},
    ...
    PythonRuntimeConfigReferenceCase{"choice-llm_provider-kilo", "{\"llm_provider\":\"kilo\"}", "{\"llm_provider\":\"kilo\"}", true, ""},
    PythonRuntimeConfigReferenceCase{"choice-llm_provider-kilo-ai", "{\"llm_provider\":\"kilo-ai\"}", "{\"llm_provider\":\"kilo\"}", true, ""},
    PythonRuntimeConfigReferenceCase{"choice-llm_provider-kilo-code", "{\"llm_provider\":\"kilo-code\"}", "{\"llm_provider\":\"kilo\"}", true, ""},
    PythonRuntimeConfigReferenceCase{"choice-llm_provider-kilo.ai", "{\"llm_provider\":\"kilo.ai\"}", "{\"llm_provider\":\"kilo\"}", true, ""},
    PythonRuntimeConfigReferenceCase{"choice-llm_provider-kilocode", "{\"llm_provider\":\"kilocode\"}", "{\"llm_provider\":\"kilo\"}", true, ""},
...
inline constexpr std::array<PythonStrategyRiskReferenceCase, 11> kPythonStrategyRiskLooseReferenceCases = {
    ...
    PythonStrategyRiskReferenceCase{"risk-loose-string-n", "{\"allow_close_ignoring_hold\":\"n\",\"allow_indicator_close_without_signal\":\"n\",\"allow_multi_indicator_close\":\"n\",\"allow_opposite_positions\":\"n\",\"auto_flip_on_close\":\"n\",\"close_on_exit\":\"n\",\"hedge_preserve_opposites\":\"n\",\"indicator_reentry_requires_signal_reset\":\"n\",\"indicator_use_live_values\":\"n\",\"positions_missing_autoclose\":\"n\",\"require_indicator_flip_signal\":\"n\",\"strict_indicator_flip_enforcement\":\"n\"}", "{\"allow_close_ignoring_hold\":false,\"allow_indicator_close_without_signal\":false,\"allow_multi_indicator_close\":false,\"allow_opposite_positions\":true,\"auto_bump_percent_multiplier\":10.0,\"auto_flip_on_close\":true,\"close_on_exit\":false,\"futures_flat_purge_grace_seconds\":12.0,\"futures_flat_purge_miss_threshold\":2,\"hedge_preserve_opposites\":false,\"indicator_flip_confirmation_bars\":1,\"indicator_flip_cooldown_bars\":1,\"indicator_flip_cooldown_seconds\":0.0,\"indicator_min_position_hold_bars\":1,\"indicator_min_position_hold_seconds\":0.0,\"indicator_reentry_cooldown_bars\":1,\"indicator_reentry_cooldown_seconds\":0.0,\"indicator_reentry_requires_signal_reset\":true,\"indicator_use_live_values\":false,\"max_auto_bump_percent\":5.0,\"positions_missing_autoclose\":true,\"positions_missing_grace_seconds\":30,\"positions_missing_threshold\":2,\"require_indicator_flip_signal\":true,\"stop_loss\":{\"enabled\":false,\"mode\":\"usdt\",\"percent\":0.0,\"scope\":\"per_trade\",\"usdt\":0.0},\"strict_indicator_flip_enforcement\":true}"},
    ...
    PythonStrategyRiskReferenceCase{"risk-loose-empty-list", "{\"allow_close_ignoring_hold\":[],\"allow_indicator_close_without_signal\":[],\"allow_multi_indicator_close\":[],\"allow_opposite_positions\":[],\"auto_flip_on_close\":[],\"close_on_exit\":[],\"hedge_preserve_opposites\":[],\"indicator_reentry_requires_signal_reset\":[],\"indicator_use_live_values\":[],\"positions_missing_autoclose\":[],\"require_indicator_flip_signal\":[],\"strict_indicator_flip_enforcement\":[]}", "{\"allow_close_ignoring_hold\":false,\"allow_indicator_close_without_signal\":false,\"allow_multi_indicator_close\":false,\"allow_opposite_positions\":false,\"auto_bump_percent_multiplier\":10.0,\"auto_flip_on_close\":false,\"close_on_exit\":false,\"futures_flat_purge_grace_seconds\":12.0,\"futures_flat_purge_miss_threshold\":2,\"hedge_preserve_opposites\":false,\"indicator_flip_confirmation_bars\":1,\"indicator_flip_cooldown_bars\":1,\"indicator_flip_cooldown_seconds\":0.0,\"indicator_min_position_hold_bars\":1,\"indicator_min_position_hold_seconds\":0.0,\"indicator_reentry_cooldown_bars\":1,\"indicator_reentry_cooldown_seconds\":0.0,\"indicator_reentry_requires_signal_reset\":false,\"indicator_use_live_values\":false,\"max_auto_bump_percent\":5.0,\"positions_missing_autoclose\":false,\"positions_missing_grace_seconds\":30,\"positions_missing_threshold\":2,\"require_indicator_flip_signal\":false,\"stop_loss\":{\"enabled\":false,\"mode\":\"usdt\",\"percent\":0.0,\"scope\":\"per_trade\",\"usdt\":0.0},\"strict_indicator_flip_enforcement\":false}"},
    PythonStrategyRiskReferenceCase{"risk-loose-nonempty-list", "{\"allow_close_ignoring_hold\":[0],\"allow_indicator_close_without_signal\":[0],\"allow_multi_indicator_close\":[0],\"allow_opposite_positions\":[0],\"auto_flip_on_close\":[0],\"close_on_exit\":[0],\"hedge_preserve_opposites\":[0],\"indicator_reentry_requires_signal_reset\":[0],\"indicator_use_live_values\":[0],\"positions_missing_autoclose\":[0],\"require_indicator_flip_signal\":[0],\"strict_indicator_flip_enforcement\":[0]}", "{\"allow_close_ignoring_hold\":true,\"allow_indicator_close_without_signal\":true,\"allow_multi_indicator_close\":true,\"allow_opposite_positions\":true,\"auto_bump_percent_multiplier\":10.0,\"auto_flip_on_close\":true,\"close_on_exit\":true,\"futures_flat_purge_grace_seconds\":12.0,\"futures_flat_purge_miss_threshold\":2,\"hedge_preserve_opposites\":true,\"indicator_flip_confirmation_bars\":1,\"indicator_flip_cooldown_bars\":1,\"indicator_flip_cooldown_seconds\":0.0,\"indicator_min_position_hold_bars\":1,\"indicator_min_position_hold_seconds\":0.0,\"indicator_reentry_cooldown_bars\":1,\"indicator_reentry_cooldown_seconds\":0.0,\"indicator_reentry_requires_signal_reset\":true,\"indicator_use_live_values\":true,\"max_auto_bump_percent\":5.0,\"positions_missing_autoclose\":true,\"positions_missing_grace_seconds\":30,\"positions_missing_threshold\":2,\"require_indicator_flip_signal\":true,\"stop_loss\":{\"enabled\":false,\"mode\":\"usdt\",\"percent\":0.0,\"scope\":\"per_trade\",\"usdt\":0.0},\"strict_indicator_flip_enforcement\":true}"},
    PythonStrategyRiskReferenceCase{"risk-loose-empty-object", "{\"allow_close_ignoring_hold\":{},\"allow_indicator_close_without_signal\":{},\"allow_multi_indicator_close\":{},\"allow_opposite_positions\":{},\"auto_flip_on_close\":{},\"close_on_exit\":{},\"hedge_preserve_opposites\":{},\"indicator_reentry_requires_signal_reset\":{},\"indicator_use_live_values\":{},\"positions_missing_autoclose\":{},\"require_indicator_flip_signal\":{},\"strict_indicator_flip_enforcement\":{}}", "{\"allow_close_ignoring_hold\":false,\"allow_indicator_close_without_signal\":false,\"allow_multi_indicator_close\":false,\"allow_opposite_positions\":false,\"auto_bump_percent_multiplier\":10.0,\"auto_flip_on_close\":false,\"close_on_exit\":false,\"futures_flat_purge_grace_seconds\":12.0,\"futures_flat_purge_miss_threshold\":2,\"hedge_preserve_opposites\":false,\"indicator_flip_confirmation_bars\":1,\"indicator_flip_cooldown_bars\":1,\"indicator_flip_cooldown_seconds\":0.0,\"indicator_min_position_hold_bars\":1,\"indicator_min_position_hold_seconds\":0.0,\"indicator_reentry_cooldown_bars\":1,\"indicator_reentry_cooldown_seconds\":0.0,\"indicator_reentry_requires_signal_reset\":false,\"indicator_use_live_values\":false,\"max_auto_bump_percent\":5.0,\"positions_missing_autoclose\":false,\"positions_missing_grace_seconds\":30,\"positions_missing_threshold\":2,\"require_indicator_flip_signal\":false,\"stop_loss\":{\"enabled\":false,\"mode\":\"usdt\",\"percent\":0.0,\"scope\":\"per_trade\",\"usdt\":0.0},\"strict_indicator_flip_enforcement\":false}"},
    PythonStrategyRiskReferenceCase{"risk-loose-nonempty-object", "{\"allow_close_ignoring_hold\":{\"enabled\":true},\"allow_indicator_close_without_signal\":{\"enabled\":true},\"allow_multi_indicator_close\":{\"enabled\":true},\"allow_opposite_positions\":{\"enabled\":true},\"auto_flip_on_close\":{\"enabled\":true},\"close_on_exit\":{\"enabled\":true},\"hedge_preserve_opposites\":{\"enabled\":true},\"indicator_reentry_requires_signal_reset\":{\"enabled\":true},\"indicator_use_live_values\":{\"enabled\":true},\"positions_missing_autoclose\":{\"enabled\":true},\"require_indicator_flip_signal\":{\"enabled\":true},\"strict_indicator_flip_enforcement\":{\"enabled\":true}}", "{\"allow_close_ignoring_hold\":true,\"allow_indicator_close_without_signal\":true,\"allow_multi_indicator_close\":true,\"allow_opposite_positions\":true,\"auto_bump_percent_multiplier\":10.0,\"auto_flip_on_close\":true,\"close_on_exit\":true,\"futures_flat_purge_grace_seconds\":12.0,\"futures_flat_purge_miss_threshold\":2,\"hedge_preserve_opposites\":true,\"indicator_flip_confirmation_bars\":1,\"indicator_flip_cooldown_bars\":1,\"indicator_flip_cooldown_seconds\":0.0,\"indicator_min_position_hold_bars\":1,\"indicator_min_position_hold_seconds\":0.0,\"indicator_reentry_cooldown_bars\":1,\"indicator_reentry_cooldown_seconds\":0.0,\"indicator_reentry_requires_signal_reset\":true,\"indicator_use_live_values\":true,\"max_auto_bump_percent\":5.0,\"positions_missing_autoclose\":true,\"positions_missing_grace_seconds\":30,\"positions_missing_threshold\":2,\"require_indicator_flip_signal\":true,\"stop_loss\":{\"enabled\":false,\"mode\":\"usdt\",\"percent\":0.0,\"scope\":\"per_trade\",\"usdt\":0.0},\"strict_indicator_flip_enforcement\":true}"},
};
...
inline constexpr std::array<PythonNativeRuntimeModeReferenceCase, 14> kPythonNativeRuntimeModeReferenceCases = {
    PythonNativeRuntimeModeReferenceCase{"empty-invalid", "", false},
    ...
    PythonNativeRuntimeModeReferenceCase{"demo-trading", "Demo Trading", true},
    PythonNativeRuntimeModeReferenceCase{"live-trading", "Live Trading", false},
    PythonNativeRuntimeModeReferenceCase{"test", "Test", true},
    PythonNativeRuntimeModeReferenceCase{"testnet", "Testnet", true},
    PythonNativeRuntimeModeReferenceCase{"sandbox", "Sandbox", true},
    PythonNativeRuntimeModeReferenceCase{"embedded-test-marker", "contest", false},
    PythonNativeRuntimeModeReferenceCase{"embedded-demo-marker", "my-demo-mode", false},
...
inline constexpr std::string_view kPythonOrderSizingReferenceJson = "{\"cases\":[{\"expected_error\":null,\"expected_quantity\":0.05,\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.02,\"stepSize\":0.01},\"market\":\"spot\",\"name\":\"spot_min_notional_bump\",\"price\":100.0,\"quantity\":0.023},{\"expected_error\":null,\"expected_quantity\":0.05,\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.02,\"stepSize\":0.01},\"market\":\"futures\",\"name\":\"futures_min_notional_bump\",\"price\":100.0,\"quantity\":0.023},{\"expected_error\":\"qty<=0\",\"expected_quantity\":0.0,\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.02,\"stepSize\":0.01},\"market\":\"spot\",\"name\":\"spot_rejects_zero_quantity\",\"price\":100.0,\"quantity\":0.0},{\"expected_error\":\"filters_error: stepSize must be a finite number >= 0\",\"expected_quantity\":0.0,\"filters\":{\"minNotional\":5.0,\"minQty\":0.02,\"stepSize\":-0.01},\"market\":\"futures\",\"name\":\"futures_invalid_step_filter\",\"price\":100.0,\"quantity\":1.0},{\"balance\":100.0,\"expected_percent\":1.0,\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.02,\"stepSize\":0.01},\"leverage\":5.0,\"market\":\"futures\",\"name\":\"futures_required_percent\",\"price\":100.0}],\"rounding_cases\":[{\"decimals\":2,\"expected_ceil\":1.24,\"expected_floor\":1.23,\"name\":\"positive_decimal\",\"value\":1.231},{\"decimals\":2,\"expected_ceil\":-1.24,\"expected_floor\":-1.23,\"name\":\"negative_decimal\",\"value\":-1.231},{\"decimals\":0,\"expected_ceil\":-2.0,\"expected_floor\":-1.0,\"name\":\"negative_integer_precision\",\"value\":-1.9}],\"schema_version\":1}";
inline constexpr std::string_view kPythonOrderIntentReferenceJson = "{\"cases\":[{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":true,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":null,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.01,\"stepSize\":0.001,\"tickSize\":0.1},\"last_price\":100.0,\"market\":\"futures\",\"name\":\"canonical-close-position\",\"params\":{\"closePosition\":\"true\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.001,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.01,\"stepSize\":0.001,\"tickSize\":0.1},\"last_price\":100.0,\"market\":\"futures\",\"name\":\"python-intent-y-is-false-filter-y-is-true\",\"params\":{\"closePosition\":\"y\",\"quantity\":\"0.001\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":true,\"market\":\"futures\",\"order_type\":\"LIMIT\",\"position_side\":\"LONG\",\"price\":2000.0,\"quantity\":1.0,\"reduce_only\":true,\"side\":\"BUY\",\"symbol\":\"ETHUSDT\"},\"intent_errors\":[\"closePosition and reduceOnly cannot be used together\"]},\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.01,\"stepSize\":0.001,\"tickSize\":0.1},\"last_price\":2000.0,\"market\":\"futures\",\"name\":\"canonical-aliases-and-conflicting-flags\",\"params\":{\"close_position\":\"yes\",\"position_side\":\"long\",\"price\":\"2000\",\"quantity\":\"1\",\"reduce_only\":\"on\",\"side\":\"BUY\",\"symbol\":\"ETHUSDT\",\"type\":\"LIMIT\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":true,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"LONG\",\"price\":null,\"quantity\":null,\"reduce_only\":true,\"side\":\"BUY\",\"symbol\":\"ETHUSDT\"},\"intent_errors\":[\"positionSide is only supported for futures\",\"closePosition orders are only supported for futures\",\"reduceOnly orders are only supported for futures\",\"closePosition and reduceOnly cannot be used together\",\"order quantity must be > 0\"]},\"filters\":{\"maxQty\":100.0,\"minNotional\":5.0,\"minQty\":0.01,\"stepSize\":0.001,\"tickSize\":0.1},\"last_price\":2000.0,\"market\":\"spot\",\"name\":\"spot-rejects-futures-flags\",\"params\":{\"closePosition\":\"true\",\"positionSide\":\"LONG\",\"reduceOnly\":\"true\",\"side\":\"BUY\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-minimum\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":1.0,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-maximum\",\"params\":{\"quantity\":\"1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.05 is below BTCUSDT marketMinQty 0.1\",\"order quantity 0.05 is not aligned to BTCUSDT marketStepSize 0.1\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.05,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-below-minimum\",\"params\":{\"quantity\":\"0.05\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 1.1 exceeds BTCUSDT marketMaxQty 1\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":1.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-above-maximum\",\"params\":{\"quantity\":\"1.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT marketStepSize 0.1\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-step\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"LIMIT\",\"position_side\":\"\",\"price\":100.0,\"quantity\":1.5,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-limit-ignores-market-lot\",\"params\":{\"price\":\"100\",\"quantity\":\"1.5\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"LIMIT\"}},{\"expected\":{\"filter_errors\":[\"order quantity 101 exceeds BTCUSDT maxQty 100\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"LIMIT\",\"position_side\":\"\",\"price\":100.0,\"quantity\":101.0,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"las"
    "t_price\":100,\"market\":\"spot\",\"name\":\"spot-general-maximum\",\"params\":{\"price\":\"100\",\"quantity\":\"101\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"LIMIT\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.1 exceeds BTCUSDT marketMaxQty 0\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":0,\"marketMinQty\":0,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-zero-maximum\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT stepSize 0.02\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-zero-step-keeps-general-step\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT stepSize 0.02\"],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.03,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-general-step-also-applies\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"spot\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.12,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.03,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"spot\",\"name\":\"spot-market-common-step\",\"params\":{\"quantity\":\"0.12\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-minimum\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":1.0,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-maximum\",\"params\":{\"quantity\":\"1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.05 is below BTCUSDT marketMinQty 0.1\",\"order quantity 0.05 is not aligned to BTCUSDT marketStepSize 0.1\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.05,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-below-minimum\",\"params\":{\"quantity\":\"0.05\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 1.1 exceeds BTCUSDT marketMaxQty 1\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":1.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-above-maximum\",\"params\":{\"quantity\":\"1.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT marketStepSize 0.1\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-step\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"LIMIT\",\"position_side\":\"\",\"price\":100.0,\"quantity\":1.5,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-limit-ignores-market-lot\",\"params\":{\"price\":\"100\",\"quantity\":\"1.5\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"LIMIT\"}},{\"expected\":{\"filter_errors\":[\"order quantity 101 exceeds BTCUSDT maxQty 100\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"LIMIT\",\"position_side\":\"\",\"price\":100.0,\"quantity\":101.0,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"min"
    "Notional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-general-maximum\",\"params\":{\"price\":\"100\",\"quantity\":\"101\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"LIMIT\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.1 exceeds BTCUSDT marketMaxQty 0\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.1,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":0,\"marketMinQty\":0,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-zero-maximum\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT stepSize 0.02\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-zero-step-keeps-general-step\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 0.15 is not aligned to BTCUSDT stepSize 0.02\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.15,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.03,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-general-step-also-applies\",\"params\":{\"quantity\":\"0.15\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":0.12,\"reduce_only\":false,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.03,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.02},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-market-common-step\",\"params\":{\"quantity\":\"0.12\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}},{\"expected\":{\"filter_errors\":[\"order quantity 1.1 exceeds BTCUSDT marketMaxQty 1\"],\"intent\":{\"close_position\":false,\"market\":\"futures\",\"order_type\":\"MARKET\",\"position_side\":\"\",\"price\":null,\"quantity\":1.1,\"reduce_only\":true,\"side\":\"SELL\",\"symbol\":\"BTCUSDT\"},\"intent_errors\":[]},\"filters\":{\"marketMaxQty\":1,\"marketMinQty\":0.1,\"marketStepSize\":0.1,\"maxQty\":100,\"minNotional\":0,\"minQty\":0.001,\"stepSize\":0.001},\"last_price\":100,\"market\":\"futures\",\"name\":\"futures-protective-exit-still-bounded\",\"params\":{\"quantity\":\"1.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"BTCUSDT\",\"type\":\"MARKET\"}}],\"execution_cases\":[{\"expected\":{\"complete\":true,\"executed_qty\":2.0,\"status\":\"FILLED\",\"valid\":true},\"name\":\"filled\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":0.0,\"status\":\"NEW\",\"valid\":true},\"name\":\"new\",\"response\":{\"executedQty\":\"0\",\"origQty\":\"2\",\"status\":\"NEW\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":1.0,\"status\":\"PARTIALLY_FILLED\",\"valid\":true},\"name\":\"partial\",\"response\":{\"executedQty\":\"1\",\"origQty\":\"2\",\"status\":\"PARTIALLY_FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":2.0,\"status\":\"PARTIALLY_FILLED\",\"valid\":true},\"name\":\"partial-not-final\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"PARTIALLY_FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":1.0,\"status\":\"CANCELED\",\"valid\":true},\"name\":\"canceled-partial\",\"response\":{\"executedQty\":\"1\",\"origQty\":\"2\",\"status\":\"CANCELED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":0.0,\"status\":\"EXPIRED\",\"valid\":true},\"name\":\"expired-empty\",\"response\":{\"executedQty\":\"0\",\"origQty\":\"2\",\"status\":\"EXPIRED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":1.0,\"status\":\"EXPIRED_IN_MATCH\",\"valid\":true},\"name\":\"expired-in-match\",\"response\":{\"executedQty\":\"1\",\"origQty\":\"2\",\"status\":\"EXPIRED_IN_MATCH\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":false,\"executed_qty\":0.0,\"status\":\"REJECTED\",\"valid\":true},\"name\":\"rejected-empty\",\"response\":{\"executedQty\":\"0\",\"origQty\":\"2\",\"status\":\"REJECTED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"new-conflicting-fill\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"NEW\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"filled-zero\",\"response\":{\"executedQty\":\"0\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"filled-short\",\"response\":{\"executedQty\":\"1\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"overfilled\",\"response\":{\"executedQty\":\"3\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"different-original\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"3\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"complete\":true,\"executed_qty\":2.0,\"status\":\"FILLED\",\"valid\":true},\"name\":\"no-original\",\"response\":{\"executedQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"missing-execution\",\"response\":{\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"missing-status\",\"response\":{\"executedQty\":\"2\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"unknown-status\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"UNKNOWN\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"numeric-status\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":1},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"lowercase-status\",\"res"
    "ponse\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"filled\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"zero-submitted\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"0\"},{\"expected\":{\"valid\":false},\"name\":\"negative-submitted\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"-2\"},{\"expected\":{\"valid\":false},\"name\":\"boolean-submitted\",\"response\":{\"executedQty\":\"2\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":true},{\"expected\":{\"valid\":false},\"name\":\"null-response\",\"response\":null,\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"negative\",\"response\":{\"executedQty\":\"-1\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"boolean\",\"response\":{\"executedQty\":true,\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"null\",\"response\":{\"executedQty\":null,\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"nan\",\"response\":{\"executedQty\":\"NaN\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"infinite\",\"response\":{\"executedQty\":\"Infinity\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"overflow\",\"response\":{\"executedQty\":\"1e999\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"malformed\",\"response\":{\"executedQty\":\"not-a-number\",\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"},{\"expected\":{\"valid\":false},\"name\":\"array\",\"response\":{\"executedQty\":[],\"origQty\":\"2\",\"status\":\"FILLED\"},\"submitted_qty\":\"2\"}],\"schema_version\":1}";
inline constexpr std::string_view kPythonLiveSafetyReferenceJson = "{\"cases\":[{\"expected_errors\":[],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"\",\"api_secret\":\"\",\"config\":{},\"leverage\":0,\"margin_mode\":\"invalid\",\"mode\":\"Demo/Testnet\",\"position_pct\":0.0},\"name\":\"demo-mode-bypasses-live-gates\"},{\"expected_errors\":[\"set live_trading_enabled=true and live_trading_acknowledgement='I_UNDERSTAND_LIVE_TRADING_RISK' or set BOT_ENABLE_LIVE_TRADING=true and BOT_LIVE_TRADING_ACKNOWLEDGEMENT='I_UNDERSTAND_LIVE_TRADING_RISK'\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{},\"leverage\":1,\"margin_mode\":\"\",\"mode\":\"Live\",\"position_pct\":2.0},\"name\":\"live-requires-confirmation\"},{\"expected_errors\":[],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":3,\"margin_mode\":\"Isolated\",\"mode\":\"Live\",\"position_pct\":2.0},\"name\":\"live-safe-futures\"},{\"expected_errors\":[\"position_pct 4% exceeds live cap 3%\"],\"input\":{\"account_type\":\"Spot\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":0,\"margin_mode\":\"invalid-is-ignored-for-spot\",\"mode\":\"Live\",\"position_pct\":4.0},\"name\":\"live-spot-position-cap\"},{\"expected_errors\":[\"live_trading_max_leverage must be between 1 and 125\",\"live_trading_max_position_pct must be > 0 and <= 100\",\"live_trading_max_session_orders must be between 1 and 100000\",\"position_pct must be > 0 and <= 100 for live trading\",\"leverage 130 exceeds live cap 126\",\"margin_mode must be Isolated or Cross for live futures trading\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":126,\"live_trading_max_position_pct\":0.0,\"live_trading_max_session_orders\":0},\"leverage\":130,\"margin_mode\":\"Portfolio\",\"mode\":\"Production\",\"position_pct\":0.0},\"name\":\"live-invalid-caps-and-futures-controls\"},{\"expected_errors\":[\"provide non-placeholder Binance API credentials\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"your_api_key\",\"api_secret\":\"testnet\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Cross\",\"mode\":\"Live\",\"position_pct\":2.0},\"name\":\"live-rejects-placeholder-credentials\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-0\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"Paper\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-1\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"Paper Local\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-2\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"contest\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-3\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"my-demo-mode\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-4\"},{\"expected_errors\":[\"unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)\"],\"input\":{\"account_type\":\"Futures\",\"api_key\":\"live-api-key\",\"api_secret\":\"live-api-secret\",\"config\":{\"live_trading_acknowledgement\":\"I_UNDERSTAND_LIVE_TRADING_RISK\",\"live_trading_enabled\":true,\"live_trading_max_leverage\":5,\"live_trading_max_position_pct\":3.0,\"live_trading_max_session_orders\":7},\"leverage\":1,\"margin_mode\":\"Isolated\",\"mode\":\"unknown\",\"position_pct\":2.0},\"name\":\"unsupported-execution-mode-5\"}],\"schema_version\":1}";
...
inline constexpr std::string_view kPythonOrderGuardBehaviorJson = "{\"environment_bool_true_values\":[\"1\",\"true\",\"yes\",\"on\"],\"live_only_requirements\":[\"credentials\",\"live_acknowledgement\",\"session_order_cap\",\"session_order_count_increment\"],\"live_safety_environment\":{\"acknowledgement\":\"BOT_LIVE_TRADING_ACKNOWLEDGEMENT\",\"enabled\":\"BOT_ENABLE_LIVE_TRADING\",\"legacy_acknowledgement\":\"BOT_LIVE_TRADING_ACK\",\"max_leverage\":\"BOT_LIVE_MAX_LEVERAGE\",\"max_position_pct\":\"BOT_LIVE_MAX_POSITION_PCT\",\"max_session_orders\":\"BOT_LIVE_MAX_SESSION_ORDERS\"},\"session_budget_exit_cases\":[{\"exempt\":true,\"market\":\"futures\",\"name\":\"one-way-long-close\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":true,\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":true,\"market\":\"futures\",\"name\":\"one-way-short-close\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"BUY\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":true,\"market\":\"futures\",\"name\":\"explicit-both-close\",\"params\":{\"positionSide\":\"BOTH\",\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":true,\"market\":\"futures\",\"name\":\"limit-close\",\"params\":{\"price\":\"100\",\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"LIMIT\"}},{\"exempt\":true,\"market\":\"futures\",\"name\":\"hedge-long-close\",\"params\":{\"positionSide\":\"LONG\",\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":true,\"market\":\"futures\",\"name\":\"hedge-short-close\",\"params\":{\"positionSide\":\"SHORT\",\"quantity\":\"0.1\",\"side\":\"BUY\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"hedge-long-entry\",\"params\":{\"positionSide\":\"LONG\",\"quantity\":\"0.1\",\"side\":\"BUY\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"hedge-short-entry\",\"params\":{\"positionSide\":\"SHORT\",\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"ordinary-sell\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"spot\",\"name\":\"spot-sell\",\"params\":{\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"spot\",\"name\":\"spot-reduce-flag\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"reduce-alias\",\"params\":{\"quantity\":\"0.1\",\"reduce_only\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"position-alias\",\"params\":{\"position_side\":\"LONG\",\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"reduce-key-case\",\"params\":{\"quantity\":\"0.1\",\"reduceonly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"reduce-key-whitespace\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly \":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"position-value-case\",\"params\":{\"positionSide\":\"long\",\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"side-value-case\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"sell\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"type-value-case\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"market\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"conflicting-alias\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"false\",\"reduce_only\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"invalid-position-side\",\"params\":{\"positionSide\":\"wrong\",\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"hedge-with-reduce-flag\",\"params\":{\"positionSide\":\"LONG\",\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"invalid-side\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"HOLD\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"unsupported-order-type\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"STOP_MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"close-all-flag\",\"params\":{\"closePosition\":\"true\",\"quantity\":\"0.1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"conflicting-close-flags\",\"params\":{\"closePosition\":\"false\",\"quantity\":\"0.1\",\"reduceOnly\":\"true\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-0\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":false,\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-1\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"false\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-2\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":1,\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-3\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"1\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-4\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"yes\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-5\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"on\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-6\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"y\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-7\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"True\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-8\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\" true \",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}},{\"exempt\":false,\"market\":\"futures\",\"name\":\"noncanonical-reduce-flag-9\",\"params\":{\"quantity\":\"0.1\",\"reduceOnly\":\"\",\"side\":\"SELL\",\"symbol\":\"ETHUSDT\",\"type\":\"MARKET\"}}],\"session_order_budget_scope\":\"exposure-increasing-submission-attempts\",\"validate_audit_enabled_all_modes\":true,\"validate_audit_writable_all_modes\":true,\"validate_connector_health_all_modes\":true,\"validate_exchange_filters_all_modes\":true,\"validate_intent_all_modes\":true}";
...
inline constexpr std::array<std::string_view, 6> kPythonNativeRuntimeTestnetModeMarkers = {
    "demo",
    "demo/testnet",
    "demo trading",
    "test",
...
inline constexpr std::array<std::string_view, 3> kPythonNativeRuntimeLiveModeValues = {
    "live",
    "live trading",
    "production",
};
inline constexpr std::string_view kPythonInvalidExecutionModeError = "unsupported execution mode (choose Live or Demo/Testnet, Paper is not exchange execution)";
...
inline constexpr std::array<std::string_view, 37> kPythonServiceRouteNames = {
    "runtime",
    "dashboard",
    "status",
    "metrics",
...
inline constexpr std::array<PythonServiceRoute, 37> kPythonServiceRoutes = {
    ...
    PythonServiceRoute{"llm_models", "/api/v1/llm/models", "GET"},
...
inline constexpr std::array<PythonServiceRouteSchema, 37> kPythonServiceRouteSchemas = {
    ...
    PythonServiceRouteSchema{"backtest", "", "", "session_id,state,workload_kind,status_message,symbols,intervals,indicator_keys,logic,symbol_source,capital,execution_model,run_count,error_count,cancelled,started_at,completed_at,updated_at,source,top_run,runs,top_runs,errors"},
    ...
    PythonServiceRouteSchema{"account", "", "total_balance,available_balance,observed_at,source", "account_type,mode,selected_exchange,connector_backend,balance_currency,total_balance,available_balance,source,generated_at"},
    PythonServiceRouteSchema{"portfolio", "", "open_position_records,closed_position_records,closed_trade_registry,active_pnl,active_margin,closed_pnl,closed_margin,total_balance,available_balance,observed_at,source", "account_type,open_position_count,closed_position_count,active_pnl,active_margin,closed_pnl,closed_margin,total_balance,available_balance,positions,source,generated_at"},
    ...
    PythonServiceRouteSchema{"llm_providers", "", "", "key,label,mode,protocol,default_base_url,default_model,api_key_env,model_suggestions,reasoning_efforts,default_reasoning_effort,api_styles,speed_options,default_speed,supports_model_discovery,model_discovery_path,catalog_revision,catalog_path,custom_models_env,custom_models_path_env,catalog_note,notes"},
    PythonServiceRouteSchema{"llm_config", "", "config", "enabled,provider,provider_label,mode,protocol,provider_protocol,api_style,api_styles,catalog_revision,catalog_path,custom_models_env,custom_models_path_env,model,base_url,api_key_env,api_key_present,allow_public_network,use_for,reasoning_effort,default_reasoning_effort,reasoning_efforts,speed,default_speed,speed_options,context_window,max_output_tokens,verbosity,temperature,top_p,timeout_seconds,request_options,supports_model_discovery,model_discovery_path,model_suggestions,notes,execution_policy"},
    PythonServiceRouteSchema{"llm_models", "", "", "ok,provider,catalog_revision,dynamic_count,models,error"},
...
inline constexpr std::array<std::string_view, 36> kPythonBacktestRunRequestFields = {
    "account_mode",
    "account_type",
    "api_key",
    "api_secret",
...
inline constexpr std::array<std::string_view, 16> kPythonLlmProviderKeys = {
    "openai",
    "kilo",
    "anthropic",
    "gemini",
...
inline constexpr std::string_view kPythonLlmProviderCatalogRevision = "2026-08-26";
...
inline constexpr std::array<PythonLlmProviderChoice, 97> kPythonLlmProviderChoices = {
    ...
    PythonLlmProviderChoice{"kilo", "kilo"},
    PythonLlmProviderChoice{"kilo-ai", "kilo"},
    PythonLlmProviderChoice{"kilo-code", "kilo"},
    PythonLlmProviderChoice{"kilo.ai", "kilo"},
    PythonLlmProviderChoice{"kilocode", "kilo"},
...
inline constexpr std::size_t kPythonOptionCatalogCount = 48;
inline constexpr std::size_t kPythonOptionCatalogEntryCount = 279;
inline constexpr std::size_t kPythonUiOptionCatalogCount = 32;
inline constexpr std::size_t kPythonUiOptionEntryCount = 122;
...
inline constexpr std::array<PythonOptionCatalogManifestEntry, 48> kPythonOptionCatalogManifest = {
    ...
    PythonOptionCatalogManifestEntry{"llm_api_style_options", 5 },
    PythonOptionCatalogManifestEntry{"llm_speed_options", 7 },
...
inline constexpr std::array<PythonUiOption, 5> kPythonLlmApiStyleOptions = {
    PythonUiOption{"provider-default", "provider-default", false},
    PythonUiOption{"openai-chat-completions", "openai-chat-completions", false},
    PythonUiOption{"openai-responses", "openai-responses", false},
    PythonUiOption{"anthropic-messages", "anthropic-messages", false},
    PythonUiOption{"gemini-generate-content", "gemini-generate-content", false},
};

inline constexpr std::array<PythonUiOption, 7> kPythonLlmSpeedOptions = {
    PythonUiOption{"default", "default", false},
    PythonUiOption{"auto", "auto", false},
    PythonUiOption{"fast", "fast", false},
    PythonUiOption{"balanced", "balanced", false},
    PythonUiOption{"quality", "quality", false},
    PythonUiOption{"flex", "flex", false},
    PythonUiOption{"priority", "priority", false},
};
...
inline constexpr std::array<PythonUiOptionCatalog, 32> kPythonUiOptionCatalogs = {
    ...
    PythonUiOptionCatalog{"LLM API style", kPythonLlmApiStyleOptions.data(), kPythonLlmApiStyleOptions.size()},
    PythonUiOptionCatalog{"LLM speed", kPythonLlmSpeedOptions.data(), kPythonLlmSpeedOptions.size()},
